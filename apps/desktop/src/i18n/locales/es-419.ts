...
export const es419: Partial<Messages> = {
  ...
  "settings.nav.remote": "Control remoto",
  ...
  "settings.remote.eyebrow": "Integración de red",
  "settings.remote.title": "Control remoto de agentes",
  "settings.remote.description": "Permite que agentes de código externos de confianza en redes privadas consulten el estado de la mascota y activen reacciones o globos de diálogo en la mascota predeterminada.",
  "settings.remote.notice.eyebrow": "Alcance y límite de seguridad",
  "settings.remote.notice.body": "El control remoto de agentes solo se aplica a la mascota predeterminada de escritorio (reacciones y voz). Los clientes remotos no tienen acceso a archivos locales, medios, historial de instrucciones, resultados de herramientas, credenciales ni estado del sistema.",
  "settings.remote.status.label": "Estado del oyente",
  "settings.remote.status.listening": "Escuchando en {address}:{port}",
  "settings.remote.status.disabled": "Desactivado",
  "settings.remote.status.error": "Detenido / Error",
  "settings.remote.enable.label": "Habilitar control remoto",
  "settings.remote.enable.description": "Inicia el oyente TCP para clientes emparejados explícitos en redes privadas.",
  "settings.remote.bindAddress.label": "Dirección de enlace",
  "settings.remote.bindAddress.placeholder": "ej. 127.0.0.1 o 192.168.1.50",
  "settings.remote.bindAddress.description": "Debe ser una dirección IPv4 privada o de bucle invertido concreta (127.0.0.1). Se rechazan los comodines (0.0.0.0).",
  "settings.remote.port.label": "Puerto",
  "settings.remote.port.placeholder": "ej. 18420",
  "settings.remote.port.description": "Puerto TCP para solicitudes entrantes de agentes (1–65535).",
  "settings.remote.saveConfig": "Guardar configuración",
  "settings.remote.warning.title": "Advertencia de transporte TCP sin cifrar",
  "settings.remote.warning.body": "Control remoto v1 usa tráfico TCP sin cifrar. SOLO debe habilitarse en una red privada de confianza o red privada superpuesta cifrada (como Tailscale o WireGuard). Nunca expongas este puerto a Internet.",
  "settings.remote.warning.ack": "Reconozco que el tráfico v1 es TCP sin cifrar y confirmo que esta es una red privada de confianza.",
  "settings.remote.warning.confirm": "Habilitar control remoto",
  "settings.remote.warning.cancel": "Cancelar",
  "settings.remote.clients.title": "Clientes emparejados",
  "settings.remote.clients.description": "Administra los agentes de código emparejados y sus permisos.",
  "settings.remote.clients.pairNew": "Emparejar nuevo cliente",
  "settings.remote.clients.none": "No hay clientes emparejados.",
  "settings.remote.clients.name": "Nombre del cliente",
  "settings.remote.clients.scopes": "Permisos",
  "settings.remote.clients.lastActivity": "Última actividad",
  "settings.remote.clients.status": "Estado",
  "settings.remote.clients.actions": "Acciones",
  "settings.remote.clients.active": "Activo",
  "settings.remote.clients.revoked": "Revocado",
  "settings.remote.clients.rotate": "Rotar token",
  "settings.remote.clients.revoke": "Revocar",
  "settings.remote.clients.confirmRotateTitle": "¿Rotar token de emparejamiento?",
  "settings.remote.clients.confirmRotateBody": "Rotar el token para '{name}' invalidará el token actual de inmediato.",
  "settings.remote.clients.confirmRevokeTitle": "¿Revocar acceso del cliente?",
  "settings.remote.clients.confirmRevokeBody": "Revocar '{name}' bloqueará de inmediato todas las solicitudes remotas futuras.",
  "settings.remote.pairModal.title": "Emparejar nuevo cliente",
  "settings.remote.pairModal.nameLabel": "Nombre del cliente / agente",
  "settings.remote.pairModal.namePlaceholder": "ej. Claude Code, Cursor, Dev Workstation",
  "settings.remote.pairModal.scopesLabel": "Alcances de acceso",
  "settings.remote.pairModal.scopeStatus": "status (Leer estado de mascota predeterminada)",
  "settings.remote.pairModal.scopeReact": "react (Activar reacciones)",
  "settings.remote.pairModal.scopeSay": "say (Mostrar globos de diálogo)",
  "settings.remote.pairModal.submit": "Generar token",
  "settings.remote.tokenModal.title": "Token de emparejamiento de único uso",
  "settings.remote.tokenModal.warning": "Este token de emparejamiento se muestra EXACTAMENTE UNA VEZ y nunca se almacena ni registra en texto plano. Asegúrate de copiarlo ahora.",
  "settings.remote.tokenModal.clientIdLabel": "ID de cliente",
  "settings.remote.tokenModal.tokenLabel": "Token Bearer",
  "settings.remote.tokenModal.guidanceTitle": "Guía de configuración del agente",
  "settings.remote.tokenModal.noEndpointGuidance": "El oyente remoto no está activo. Configura y habilita una dirección y puerto válidos para derivar el punto de enlace tcp://<address>:<port>.",
  "settings.remote.tokenModal.copyToken": "Copiar token",
  "settings.remote.tokenModal.copied": "¡Copiado!",
  "settings.remote.tokenModal.done": "Listo",
  "settings.remote.error.configInvalid": "La configuración del control remoto no es válida.",
  "settings.remote.error.pairFailed": "No se pudo emparejar el cliente remoto.",
  "settings.remote.error.rotateFailed": "No se pudo rotar el token del cliente.",
  "settings.remote.error.revokeFailed": "No se pudo revocar el cliente.",
  "settings.remote.clients.idLabel": "ID: {id}",
  "settings.remote.clients.lastActive": "Última actividad: {time}",
  "settings.remote.clients.neverActive": "Nunca",
  "settings.remote.tokenModal.posixLabel": "Entorno POSIX / Bash",
  "settings.remote.tokenModal.powerShellLabel": "Entorno PowerShell",
  "settings.remote.tokenModal.cliCheckLabel": "Verificación de conectividad CLI",
  "settings.remote.tokenModal.cliCheckExplanation": "Verifica la conexión remota emparejada con una sola comprobación de estado.",
  "settings.toast.remoteConfigSaved": "Configuración guardada.",
  "settings.toast.remoteClientPaired": "Nuevo cliente emparejado.",
  "settings.toast.remoteClientRotated": "Token rotado con éxito.",
  "settings.toast.remoteClientRevoked": "Cliente revocado.",
  ...
  "settings.waitingAnimationDuration.title": "Velocidad de la animación de espera",
  "settings.waitingAnimationDuration.description": "Elige la rapidez con la que se repite el ciclo de espera para mascotas integradas e instaladas.",
  "settings.waitingAnimationDuration.normal": "Normal (1010 ms)",
  "settings.waitingAnimationDuration.relaxed": "Relajada (2200 ms)",
  ...
  "settings.toast.waitingAnimationSaved": "Velocidad de la animación de espera guardada.",
  ...
  "integrations.zed.description": "Conecta Zed a tu compañero de OpenPets mediante la configuración global de MCP.",
  "integrations.zed.settingsPath": "Archivo de configuración",
  "integrations.zed.mcpEntryPreview": "Vista previa de la entrada MCP",
